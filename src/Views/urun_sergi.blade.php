                            ...
                            <div class="col-md-4" style="margin-bottom: 10px;">
                                <div style="width: 100%; text-align: center" class="img-thumbnail">
                                    ...
                                    <div style="margin-right: auto; margin-bottom: 10px; margin-left: auto;" class="img-thumbnail">
                                        <a href="/acr/ilan/product/detail?product_id={{$product->id}}"> <img
                                        ...
                                        <div style=" width: 50px;  position: absolute; right: -10px; top:50px;">
                                            <a target="_blank" class="saga_yasla sola_cek" href="https://www.facebook.com/sharer/sharer.php?u={{$web}}/acr/ilan/product/detail?product_id={{$product->id}}"><img width="40"
                                                                                                                                                                                                                src="/icon/bF.png"></a>
                                            <br><br><br>

                                            <a target="_blank" class="saga_yasla sola_cek"
                                               href="http://twitter.com/intent/tweet?text=1.sinifokumayazmaplani.rar&amp;url={{$web}}/acr/ilan/product/detail?product_id={{$product->id}}/&amp;via=oevrak Önlük Baskı">
                                                <img width="40" src="/icon/bT.png">
                                            </a>
                                            <br><br><br>

                                            <a target="_blank" class="saga_yasla sola_cek"
                                               href="http://pinterest.com/pin/create/link/?url={{$web}}/acr/ilan/product/detail?product_id={{$product->id}}&amp;description=1">
                                    ...
                                    <a style="float: right" class="btn btn-success btn-lg" href="/acr/ilan/product/detail?product_id={{$product->id}}">Detay>></a>
                                </div>
                            </div>
                        @endif
                    @endforeach
